...
internal class TypedIdValueConverter<TTypedId, TKey> : ValueConverter<TTypedId, TKey>
    ...
    where TKey : notnull
{
    ...
    {
        var constructedType = typeof(TTypedId).MakeGenericType([typeof(TKey)]);
        return Activator.CreateInstance(constructedType, [value]) is TTypedId typedId
            ? typedId
